...
/**
 * http://www.ekiras.com/2015/03/how-to-create-pagination-taglib-in-java-spring-for-bootstrap.html
 */
    ...
    private String constructLink(int page, String text, String className, boolean disabled) {
        ...
        if(disabled)
            ...
            if (search != null && !"".equals(search))
                link.append(">").append("<a href=\""+uri+"?search="+search+"&offset="+page + "\">"+text+"</a></li>");
            else
